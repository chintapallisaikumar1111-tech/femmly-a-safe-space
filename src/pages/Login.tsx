...
// HARDOCODED DEMO CREDENTIALS
const DEMO_USERS = [
  { email: "demo@femmly.app", password: "demo123" },
  { email: "admin@femmly.app", password: "admin123" },
];
...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validUser) {
      // Store session
      sessionStorage.setItem("femmly_user", email);
      sessionStorage.setItem("femmly_role", email.includes("admin") ? "admin" : "demo");
      navigate("/admin");
    } else {
