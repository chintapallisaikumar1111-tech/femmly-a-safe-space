...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const fetchProfile = async (userId: string) => {
    ...
    if (roles) setIsAdmin(roles.some((r: any) => r.role === "admin"));
  };
  ...
  return (
    <AuthContext.Provider value={{ user, session, loading, isVerified, isAdmin, signUp, signIn, signOut, refreshProfile }}>
      {children}
